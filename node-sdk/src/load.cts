...
module.exports = require('@neon-rs/load').proxy({
  platforms: {
    'win32-x64-msvc': () => require('@node-sdk/win32-x64-msvc'),
    'darwin-x64': () => require('@node-sdk/darwin-x64'),
    'darwin-arm64': () => require('@node-sdk/darwin-arm64'),
    'linux-x64-gnu': () => require('@node-sdk/linux-x64-gnu'),
    'linux-arm64-gnu': () => require('@node-sdk/linux-arm64-gnu')
  },
